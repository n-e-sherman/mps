#ifndef __GROUNDSTATETUNE_H_
#define __GROUNDSTATETUNE_H_
...
class GroundStateTune : public State
{
...
public:
	...
	GroundStateTune(Args* a) : args(a) {}
	GroundStateTune(Args* a, Model* m) : args(a), model(m)
	{
		sites = model->getSites();
		buildInitialState();
		auto J1s = stringToVector(args->getString("J1s"));
		for(auto J1 : J1s)
		{
